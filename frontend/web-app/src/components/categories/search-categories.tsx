            ...
            {categories.map((category: CategoryDto) => (
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="h-16 w-24 bg-gray-100 rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                    <img
                      src={category.image || "https://scdn-stc.vnggames.com/mainsite/images/lol-banner-600x337.png"}
                      alt={category.name}
