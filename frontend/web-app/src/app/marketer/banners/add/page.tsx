                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Tạo banner hiển thị trên trang chủ</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <button type="submit" disabled={createBanner.isPending} className="px-6 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition disabled:opacity-50">
                                {createBanner.isPending ? "Đang tạo..." : "Tạo banner"}
                            </button>
                        </div>
                    </form>
                </div>
